var MyClient = MyClient || {}; MyClient["Widgets"] = MyClient["Widgets"] || {}; MyClient["Widgets"]["MyFirstReactComponent"] =
...
var MyFirstReactComponent = /** @class */ (function (_super) {
    __extends(MyFirstReactComponent, _super);
    /**
     *
     */
    ...
    MyFirstReactComponent.prototype.componentWillMount = function () {
        var cur = this;
    ...
    MyFirstReactComponent.prototype.AkRender = function () {
        console.log('AkRender');
        this.setState({ pageLifecycleComplete: true });
    };
    MyFirstReactComponent.prototype.Increment = function () {
        this.setState({ testIncrement: this.state.testIncrement + 1 });
    };
    MyFirstReactComponent.prototype.render = function () {
    ...
    return MyFirstReactComponent;
}(React.Component));
exports.MyFirstReactComponent = MyFirstReactComponent;
