    ...
    return (
      <SplashContainer>
        ...
        <div className="inner">
          ...
          <PromoSection>
            <NewButton href={docUrl('Akumina-Framework-5.0.0.0-Overview.html')}>Akumina 5.0</NewButton>
            ...
            <NewButton href={docUrl('AK-Stream-Card-Builder.html')}>Stream Card Builder</NewButton>
