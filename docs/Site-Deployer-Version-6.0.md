...
| `tenantid` | Used by new auth flow | | 
...
| `akquerykey` | AppManager Query key - for use with contentapp option | 'backgroundprocessorkey' in tenant settings |
